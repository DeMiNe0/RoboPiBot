...
# Version 1.0 www.custom-build-robots.com mjpg-streamer
### BEGIN INIT INFO
...
case "$1" in
	start)
		...
		/opt/mjpg-streamer/mjpg_streamer -i "/opt/mjpg-streamer/input_uvc.so -d /dev/video0 -r 800x640 -f 25" -o "/opt/mjpg-streamer/output_http.so -p 8080 -w /opt/mjpg-streamer/www -n" >> /home/pi/mjpg-streamer.log>&1 &
	...
	status)
		...
		then
			...
			f_message "mjpg-streamer was started with the following command line" cat /proc/${pid}/cmdline ; echo ""
		else
